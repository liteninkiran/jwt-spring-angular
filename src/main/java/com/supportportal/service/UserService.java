...
public interface UserService {
    ...
    User register(String firstName, String lastName, String username, String email) throws com.supportportal.exception.domain.UserNotFoundException, UsernameExistException, EmailExistException, MessagingException;
